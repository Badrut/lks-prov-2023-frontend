                            ...
                            <form className="card card-default" onSubmit={handleLogin}>
                                ...
                                <div className="card-body">
                                    <div className="form-group row align-items-center">
                                        ...
                                        <div className="col-8"><input type="text" className="form-control" name="idcard" value={idcard} onChange={(e) => setIdCard(e.target.value)} /></div>
                                    </div>
                                    <div className="form-group row align-items-center">
                                        <div className="col-4 text-right">Password</div>
                                        <div className="col-8"><input type="password" className="form-control" name="password" value={password} onChange={(e) => setPassword(e.target.value)}  /></div>
                                    </div>
